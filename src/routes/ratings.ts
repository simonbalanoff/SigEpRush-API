...
router.post("/pnms/:id/ratings", requireAuth, async (req: AuthedRequest, res) => {
...
router.get("/pnms/:id/ratings", requireAuth, async (req: AuthedRequest, res) => {
...
router.delete("/pnms/:id/ratings/mine", requireAuth, async (req: AuthedRequest, res) => {
    const pnmId = req.params.id;
